...
# TODO: Ensure this is the correct GitHub homepage where releases can be downloaded for air.
GH_REPO="https://github.com/air-verse/air"
TOOL_NAME="air"
TOOL_TEST="air -v"
...
# NOTE: You might want to remove this if air is not hosted on GitHub releases.
...
install_version() {
	...
	(
		...
		# TODO: Assert air executable exists.
		local tool_cmd
